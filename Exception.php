...
class Exception extends \Exception {
	...
	public function __construct($strMessage, $nCode) {
		if (is_null($strMessage) && isset($this->arrMap[$nCode])) {
			$strMessage = $this->arrMap[$nCode];
		}
		parent::__construct($strMessage, $nCode);
	}
}
?>
