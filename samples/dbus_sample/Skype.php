...
class Skype {
	...
	public function handleChat($s) {
		...
		$this->requestCallback($this->callback['chat'], $chat, $chat_id, $property, $value);
	}
	...
	public function handleChats($s) {
		...
		$this->requestCallback($this->callback['chats'], $chat_id_list);
	}
	...
	public function handleChatmessage($s) {
		...
		$this->requestCallback($this->callback['chatmessage'], $chatmessage, $chatmessage_id, $property, $value);
	}

	public function handleConnstatus($status) {
		$this->connection_status = $status;
		$this->requestCallback($this->callback['connstatus'], $status);
	}
	...
	public function handleContacts($s) {
		...
		$this->requestCallback($this->callback['contacts'], $this->contact_focus);
	}

	public function handleCurrentuserhandle($current_user_handle) {
		$this->current_user_handle = $current_user_handle;
		$this->requestCallback($this->callback['currentuserhandle'], $current_user_handle);
	}
	...
	public function handleFiletransfer($s) {
		...
		$this->requestCallback($this->callback['filetransfer'], $filetransfer, $filetransfer_id, $property, $value);
	}
	...
	public function handleGroup($s) {
		...
		$this->requestCallback($this->callback['group'], $group, $group_id, $property, $value);
	}
	...
	public function handleUser($s) {
		...
		$this->requestCallback($this->callback['user'], $user, $user_id, $property, $value);
	}

	public function handleUserStatus($user_status) {
		$this->user_status = $user_status;

		$this->requestCallback($this->callback['userstatus'], $user_status);
	}
	/* }}} */
	...
	protected function requestCallback($callback_list, $args) {
		$args = func_get_args();
		array_shift($args);
